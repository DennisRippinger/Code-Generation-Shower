...
gulp.task('font_download', function(){
  download("https://github.com/tonsky/FiraCode/releases/download/1.200/FiraCode_1.200.zip")
    .pipe(unzip({
      filter : function(entry){
        return minimatch(entry.path, "**/*FiraCode*")
      }
    }))
